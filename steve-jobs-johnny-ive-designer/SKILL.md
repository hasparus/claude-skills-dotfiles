...
Read the repository and understand its purpose these before forming any opinion. No exceptions.
Use /agent-browser to walk through the live app.
...
- Update PROGRESS.md with what design changes were made
